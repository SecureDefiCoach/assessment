...
export class PredefinedWorkflows {
   ...
   */
  public static getAllWorkflows(): WorkflowDefinition[] {
    return [
   ...
   */
  public static getWorkflow(name: string): WorkflowDefinition | undefined {
   ...
   */
  public static getCompatibleWorkflows(codebaseType: string): WorkflowDefinition[] {
    return this.getAllWorkflows().filter(workflow => 
      workflow.codebaseTypes.includes(codebaseType) || workflow.codebaseTypes.includes('*')
    );
  }
   ...
   */
  public static getNodeJSWorkflow(): WorkflowDefinition {
    return {
   ...
   */
  public static getSolidityWorkflow(): WorkflowDefinition {
    return {
   ...
   */
  public static getMixedWorkflow(): WorkflowDefinition {
    return {
   ...
   */
  public static getQuickScanWorkflow(): WorkflowDefinition {
    return {
      name: 'quick-scan',
   ...
   */
  public static getDeepAnalysisWorkflow(): WorkflowDefinition {
    return {
      name: 'deep-analysis',
   ...
   */
  public static autoSelectWorkflow(
    codebaseType: string,
